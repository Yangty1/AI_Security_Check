...
from ultralytics.data.loaders import LoadStreams, LoadImagesAndVideos, LoadImages
from ultralytics.engine.model import Model
from ultralytics.nn import attempt_load_weights
from ultralytics.utils.CustomMessageBox import MessageBox
from dialog.rtsp_win import Window
from ultralytics.utils.LetterBox import letterbox
...
# from ultralytics.utils.datasets import LoadStreams, LoadImages, LoadWebcam
# from ultralytics.utils.general import check_imgsz, check_requirements, check_imshow, non_max_suppression, apply_classifier, \
...
class DetThread(QThread):
    ...
    def __init__(self):
        ...
        self.current_weight = 'weights/best.pt'
        self.source = '0'
    ...
    def run(self,
        ...
        model = YOLO('D:/A_BiShe/projectspace/ultralytics-8.2.0/weights/best_yolov8x.pt.pt')
        result = model(['D:\A_BiShe\projectspace\SIXray\VOC2007_SIXRAY\JPEGImages\P00004.jpg'])
        self.send_img.emit(result[0])
        ...
        try:
            ...
            print('1')
            # Load model
            model = attempt_load_weights(self.weights, device=device)  # load FP32 model
            num_params = 0
            ...
            if webcam:
                ...
                dataset = LoadImages(self.source,imgsz,stride=stride)
            ...
            while True:
                ...
                if self.is_continue:
                    print('ss')
                    # print(type(next(dataset_iter)))
                    path,img,im0s,self.vid_cap = next(dataset_iter)
                    print('kk')
                    print(self.vid_cap)
                    print('ssssss')
                    # print(self.vid_cap)
...
class MainWindow(QMainWindow, Ui_mainWindow):
    def __init__(self, parent=None):
        ...
        self.pt_list = [file for file in self.pt_list if file.endswith('./weights')]
