...
# Form implementation generated from reading UI_NEW file 'win.UI_NEW'
#
...
"border-radius:0px;}")
        ...
        self.label_7.setStyleSheet("image: url(icon/conan.png);")
...
"background-color: rgba(223, 223, 223, 150);}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("icon/最小化.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"background-color: rgba(223, 223, 223, 150);}")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icon/正方形.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon2.addPixmap(QtGui.QPixmap("icon/还原.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon2.addPixmap(QtGui.QPixmap("icon/还原.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
...
"background-color: rgba(223, 223, 223, 150);}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("icon/关闭.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"background-color: rgba(48,148,243,80);}")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("icon/打开.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"background-color: rgba(48,148,243,80);}")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("icon/摄像头开.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"background-color: rgba(48,148,243,80);}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("icon/实时视频流解析.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"background-color: rgba(223, 223, 223, 150);}")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("icon/运行.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon7.addPixmap(QtGui.QPixmap("icon/暂停.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon7.addPixmap(QtGui.QPixmap("icon/运行.png"), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
        icon7.addPixmap(QtGui.QPixmap("icon/暂停.png"), QtGui.QIcon.Disabled, QtGui.QIcon.On)
        icon7.addPixmap(QtGui.QPixmap("icon/运行.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon7.addPixmap(QtGui.QPixmap("icon/暂停.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon7.addPixmap(QtGui.QPixmap("icon/运行.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        icon7.addPixmap(QtGui.QPixmap("icon/暂停.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
...
"background-color: rgba(223, 223, 223, 150);}")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("icon/终止.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.label_4.setText(_translate("mainWindow", "智能安检系统"))
        ...
        self.label_11.setText(_translate("mainWindow", "结果集"))
        self.label_6.setText(_translate("mainWindow", "图像"))
